...
//            }
    ...
    public void onCreate() {
        ...
        //서비스 실행
        intent1=new Intent(FloatingWidgetService.this, FlowerService.class);
...
//                break;
            case R.id.close_expanded_view:
                ...
                resetPosition(x_cord_l);
                break;
            case R.id.open_activity_button:
                //open the activity and stop service
                Intent intent = new Intent(FloatingWidgetService.this, MainActivity2.class);
                stopService(intent1);
